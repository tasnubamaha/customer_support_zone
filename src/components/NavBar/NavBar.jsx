...
const NavBar = () => {
  ...
  <div>
    ...
    <a className='mr-6 ' href="">FAQ</a>
    <a className='mr-6 ' href="">ChangeLog</a>
    <a className='mr-6 ' href="">Blog</a>
    <a className='mr-6 ' href="">Download</a>
    <a className='mr-6 ' href="">Contact</a>
  </div>
